...
window.GAME_TALENTS = [
  {
    ...
    "name": "斗酒诗百篇",
    "kind": "passive",
    "text": "「李白斗酒诗百篇，长安市上酒家眠。」——杜甫《饮中八仙歌》。以诗出战获胜时，修为随文心而进。【小整数规则】以诗获胜，心得+2。",
    "effect": {
      "type": "on_win_bonus",
      "style": "shi",
      "value": 2,
  ...
  },
  {
    ...
    "name": "倚声填词",
    "kind": "passive",
    "text": "词本倚声而作，先有腔调后有文字。填词日久，声律入骨——以词出战获胜时，修为随文心而进。【小整数规则】以词获胜，心得+2。",
    "effect": {
      "type": "on_win_bonus",
      "style": "ci",
      "value": 2,
  ...
  },
  {
    ...
    "name": "对对如流",
    "kind": "passive",
    "text": "属对之才，出口成双。相传解缙幼时应对如流，一座皆惊——以联出战获胜时，修为随文心而进。【小整数规则】以联获胜，心得+2。",
    "effect": {
      "type": "on_win_bonus",
      "style": "lian",
      "value": 2,
  ...
  },
  {
    ...
    "name": "博览",
    "kind": "passive",
    "text": "「读书破万卷，下笔如有神。」——杜甫《奉赠韦左丞丈二十二韵》。腹笥既广，修为随文心而进。【小整数规则】学力常驻+3。",
    "effect": {
      "type": "attr_flat",
      "attrs": {
        "xue": 3
  ...
  },
  {
    ...
    "name": "入木三分",
    "kind": "passive",
    "text": "相传王羲之题字于木，工人削之，墨迹入木三分。修为随文心而进。【小整数规则】笔力常驻+3。",
    "effect": {
      "type": "attr_flat",
      "attrs": {
        "bi": 3
  ...
  },
  {
    ...
    "name": "推敲",
    "kind": "passive",
    "text": "贾岛于驴背上吟「僧敲月下门」，「推」「敲」难定，冲撞韩愈仪仗；韩愈曰：作敲字佳。字字斟酌，修为随文心而进。【小整数规则】思力常驻+3。",
    "effect": {
      "type": "attr_flat",
      "attrs": {
        "si": 3
  ...
  },
  {
    ...
    "name": "囊萤映雪",
    "kind": "passive",
    "text": "晋人车胤囊萤照读，孙康映雪读书。贫不废学，修为随文心而进。【小整数规则】学力常驻+3。",
    "effect": {
      "type": "attr_flat",
      "attrs": {
        "xue": 3
  ...
  },
  {
    ...
    "name": "天马行空",
    "kind": "passive",
    "text": "笔势腾踔，不拘辙迹。首枚续掷少耗 2 灵感；收笔时三枚灵感骰点数各不相同，作品得分 +15%，并得成稿进度 10（每场一次）。",
    "effect": {
      "type": "dice_pattern",
  ...
  },
  {
    ...
    "name": "李杜文章",
    "kind": "passive",
    "text": "「李杜文章在，光焰万丈长。」——韩愈《调张籍》。以诗出战获胜时，修为随文心而进。需先有「浪漫主义」倾向。【小整数规则】以诗获胜，心得+3。",
    "effect": {
      "type": "on_win_bonus",
      "style": "shi",
      "value": 3,
  ...
  },
  {
    ...
    "name": "凡有井水处",
    "kind": "passive",
    "text": "南宋叶梦得《避暑录话》载：凡有井水饮处，即能歌柳词。以词出战获胜时，修为随文心而进。需先有「婉约派」倾向 ×2。【小整数规则】以词获胜，心得+3。",
    "effect": {
      "type": "on_win_bonus",
      "style": "ci",
      "value": 3,
  ...
  },
  {
    ...
    "name": "铁板铜琶",
    "kind": "passive",
    "text": "俞文豹《吹剑续录》载幕士评东坡词：须关西大汉，执铁板，唱「大江东去」。以联出战获胜时，修为随文心而进。需先有「豪放派」倾向。【小整数规则】以联获胜，心得+3。",
    "effect": {
      "type": "on_win_bonus",
      "style": "lian",
      "value": 3,
  ...
  },
  {
    ...
    "name": "曲水流觞",
    "kind": "passive",
    "text": "王羲之《兰亭集序》载：引以为流觞曲水，列坐其次。雅集唱和，从容不迫——与对手平分秋色时，出战文体额外 +3。【小整数规则】平局时心得+3。",
    "effect": {
      "type": "draw_bonus",
      "value": 3,
      "resource": "insight"
  ...
  },
  {
    ...
    "name": "转益多师",
    "kind": "passive",
    "text": "杜甫《戏为六绝句》：转益多师是汝师。败于名家而有所悟，平局亦能取法——「败中有得」「平分秋色」的补偿修为随文心而进，下一场得分 +4%。【小整数规则】平局或败北时心得+2，下一场作品修正+4%。",
    "effect": {
      "type": "study_bonus",
      "value": 2,
      "nextBattlePct": 400,
  ...
  },
  {
    ...
    "name": "字字珠玑",
    "kind": "passive",
    "text": "字字圆转，句句有光。若本场全部灵感骰最终均不低于 4 点，作品得分 +10%，并额外获得 20 成稿进度（每场一次）。",
    "effect": {
      "type": "dice_pattern",
      "pattern": "all_high",
      "minPip": 4,
  ...
  },
  {
    ...
    "name": "妙手偶得",
    "kind": "passive",
    "text": "陆游诗云：文章本天成，妙手偶得之。每枚最终六点骰使作品得分 +8%；本场出现六点骰时另得 20 成稿进度（奖励每场一次）。",
    "effect": {
      "type": "dice_pattern",
      "pattern": "six",
      "value": 800,
