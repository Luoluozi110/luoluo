...
window.GAME_TALENTS = [
  {
    ...
    "name": "斗酒诗百篇",
    "kind": "passive",
    "text": "「李白斗酒诗百篇，长安市上酒家眠。」——杜甫《饮中八仙歌》。以诗出战获胜时，诗力额外 +1。",
    "effect": {
      "type": "on_win_bonus",
      "style": "shi",
      "value": 1
  ...
  },
  {
    ...
    "name": "倚声填词",
    "kind": "passive",
    "text": "词本倚声而作，先有腔调后有文字。填词日久，声律入骨——以词出战获胜时，词力额外 +1。",
    "effect": {
      "type": "on_win_bonus",
      "style": "ci",
      "value": 1
  ...
  },
  {
    ...
    "name": "对对如流",
    "kind": "passive",
    "text": "属对之才，出口成双。相传解缙幼时应对如流，一座皆惊——以联出战获胜时，联力额外 +1。",
    "effect": {
      "type": "on_win_bonus",
      "style": "lian",
      "value": 1
  ...
  },
  {
    ...
    "name": "博览",
    "kind": "passive",
    "text": "「读书破万卷，下笔如有神。」——杜甫《奉赠韦左丞丈二十二韵》。腹笥既广，学力常驻 +2。",
    "effect": {
      "type": "attr_flat",
      "attrs": {
        "xue": 2
  ...
  },
  {
    ...
    "name": "急智",
    "kind": "passive",
    "text": "临场生风，机锋不落。首骰为 1—2 点时，首次续掷少耗 2 灵感；续骰若为 5—6 点，作品得分 +10%。低开而能翻盘，方见机锋。",
    "effect": {
      "type": "dice_pattern",
  ...
  },
  {
    ...
    "name": "囊萤映雪",
    "kind": "passive",
    "text": "晋人车胤囊萤照读，孙康映雪读书。贫不废学，学力常驻 +2。",
    "effect": {
      "type": "attr_flat",
      "attrs": {
        "xue": 2
  ...
  },
  {
    ...
    "name": "天马行空",
    "kind": "passive",
    "text": "笔势腾踔，不拘辙迹。首枚续掷少耗 2 灵感；三枚灵感骰点数各不相同，作品得分 +15%，并得残页 0.5。",
    "effect": {
      "type": "dice_pattern",
  ...
  },
  {
    ...
    "name": "文思泉涌",
    "kind": "passive",
    "text": "思若泉涌，源源不绝。首枚续掷少耗 1 灵感；每枚续骰都高于前骰时，每次递升得分 +5%；三骰连升另 +10%，并得 1 灵感。",
    "effect": {
      "type": "dice_pattern",
      "pattern": "ascending",
      "minDice": 2,
  ...
  },
  {
    ...
    "name": "七步成诗",
    "kind": "active",
    "text": "《世说新语·文学》载曹植七步成诗：「本自同根生，相煎何太急。」本场首枚续掷免费；前两骰合计恰为 7 点，作品得分 +18%，并得 1 心得。",
    "effect": {
      "type": "dice_pattern",
      "pattern": "exact_total",
      "diceCount": 2,
  ...
  },
  {
    ...
    "name": "一气呵成",
    "kind": "active",
    "text": "行文如一线贯珠，中无断续。支付首枚续掷后，自动续得第二枚骰（不再消耗灵感）；若自动续骰不低于首枚续骰，作品得分再 +4%。",
    "effect": {
  ...
  },
  {
    ...
    "name": "倚马可待",
    "kind": "active",
    "text": "《世说新语·文学》载袁虎倚马前，须臾作露布文七纸，殊可观。本场三骰总点至少 12 时得分 +16% 并返还 3 灵感；若达到 16 点，则改为得分 +30% 并同样返还灵感。未达标则徒耗锋芒。",
    "effect": {
      "type": "dice_pattern",
      "pattern": "total_tiers",
      "tiers": [
  ...
  },
  {
    ...
    "name": "诗骨嶙峋",
    "kind": "passive",
    "text": "「为人性僻耽佳句，语不惊人死不休。」——杜甫《江上值水如海势聊短述》。诗乃风骨所寄，以诗出战，格调天然高出一筹——得分常驻 +6%。",
    "effect": {
      "type": "style_pct",
      "style": "shi",
      "value": 0.06
  ...
  },
  {
    ...
    "name": "咏物通灵",
    "kind": "passive",
    "text": "「体物之工，穷情写貌。」咏物一题，体察入微，形神兼备——出战「咏物」题材时得分 +8%。",
    "effect": {
      "type": "theme_pct",
      "theme": "yongwu",
      "value": 0.08
