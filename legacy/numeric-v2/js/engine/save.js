...
export const RUN_SAVE_KEY = 'feihua_legacy_v2_feihua_run_save';               // 自动存档槽（每回合结束）
export const RUN_SAVE_MANUAL_KEY = 'feihua_legacy_v2_feihua_run_save_manual'; // 手动存档槽（菜单「保存当前进度」）
export const RUN_SAVE_TUTORIAL_KEY = 'feihua_legacy_v2_feihua_run_save_tutorial'; // 教学局存档槽（入门卷专用，与正式对局隔离）
