...
assert.deepEqual(moved, { arrived: 'gate', gateIndex: 72 }, '跨入中圈时必须停在第72格晋阶门，不能越门');
...
game.d6 = () => 4;
await game.playTurn();
assert.equal(game.s.routeIndex, 72, '完整回合从70掷4也必须停在举人门');
