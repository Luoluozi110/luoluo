...
assert.match(html, /src="js\/ui\/app\.js\?v=20260909numeric3"/, '入口缓存版本必须更新');
assert.match(html, /"\.\/js\/engine\/numeric\.js":"\.\/js\/engine\/numeric\.js\?v=20260909numeric3"/, '数值模块必须使用同一发布版本');
