...
try {
  ...
  console.log('PASS: five viewports; outer/middle/inner/secret states; waypoint visibility and landmark clearance; mobile panels, current position and low quality.');
